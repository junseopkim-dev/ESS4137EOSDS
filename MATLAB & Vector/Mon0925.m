...
hold on, plot(S(317).X,S(317).Y,'b-','linewidth',2);

%------------------------------------------------

in=inpolygon(lon,lat,S(317).X,S(317).Y);
in=in';
...
in = double(in);
in(in==0)=nan;
blue_rad_ROI=blue_rad.*in;

figure,imagesc(blue_rad_ROI,[0 100]),colorbar,colormap(gray);axis xy;

nanmean(blue_rad_ROI(:))
cd C:\Users\kjs\Documents\3-2\EOSDS\practice\subset_0_of_LC09_L1TP_114036_20230805_20230805_02_T1
